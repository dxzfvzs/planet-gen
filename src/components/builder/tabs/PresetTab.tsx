import { RandomiseButton, SectionCard } from "../ui-collection.tsx";
import { usePlanet } from "../usePlanet.ts";
import { FULL_PRESETS } from "../presets.ts";

export function PresetTab() {
  const { applyFullPreset, randomiseRings, randomiseMoons, randomiseAll } = usePlanet();

  return (
    <div className="space-y-3">
      <SectionCard title="Full Presets">
