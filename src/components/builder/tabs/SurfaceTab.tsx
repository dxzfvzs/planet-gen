...
import { Label, SectionHead, SliderRow, TextInput } from "../ui-collection.tsx";
    ...
    <div className="space-y-4">
      ...
      <div className="mb-2 flex items-center gap-2">
        <div className="flex-1">
          ...
          <div className="mt-1 flex gap-1">
            <TextInput value={bandSeed} onChange={onBandSeedChange} placeholder="band seed" />
            <button
              onClick={() => onBandSeedChange(randSeed())}
              className="cursor-pointer rounded-lg border border-white/10 bg-white/5 p-1.5 text-violet-400 transition-colors hover:text-violet-200"
            >
              <Shuffle size={13} />
            </button>
          </div>
      ...
      <div className="mb-2 flex items-center gap-2">
        <div className="flex-1">
          <Label>Seed</Label>
          <div className="mt-1 flex gap-1">
            <TextInput value={softSeed} onChange={onSoftSeedChange} placeholder="soft seed" />
            <button
              onClick={() => onSoftSeedChange(randSeed())}
              className="cursor-pointer rounded-lg border border-white/10 bg-white/5 p-1.5 text-violet-400 transition-colors hover:text-violet-200"
            >
              <Shuffle size={13} />
            </button>
